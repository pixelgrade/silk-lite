...
?>
	...
	<footer id="colophon" class="site-footer">
		...
		<div class="site-info" role="contentinfo">
			...
			<span class="sep"> | </span>
			<?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'silk-lite' ), 'Silk', '<a href="https://pixelgrade.com/?utm_source=theme&utm_medium=footer&utm_campaign=silk-lite" title="'. __( 'The PixelGrade Website', 'silk-lite' ) .'" rel="designer">PixelGrade</a>' ); ?>

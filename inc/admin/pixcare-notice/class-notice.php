...
class SilkLite_PixelgradeCare_DownloadNotice {

	protected $download_url;

	/**
	 * The only instance.
	 * @var     SilkLite_PixelgradeCare_DownloadNotice
	 * @access  protected
	 */
	...
	/**
	 * Main SilkLite_PixelgradeCare_DownloadNotice Instance
	 *
	 * Ensures only one instance of SilkLite_PixelgradeCare_DownloadNotice is loaded or can be loaded.
	 *
	 * @static
	 *
	 * @return SilkLite_PixelgradeCare_DownloadNotice Main SilkLite_PixelgradeCare_DownloadNotice instance
	 */
